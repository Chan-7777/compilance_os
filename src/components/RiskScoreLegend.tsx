...
export function RiskScoreLegend() {
    ...
    return (
        <div style={containerStyle}>
            ...
            >
                <span style={{ ...titleStyle, display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: colors.accent }}><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
                    How is the risk score calculated?
                </span>
                <span style={{ ...toggleIconStyle, display: 'inline-flex', alignItems: 'center' }}>
