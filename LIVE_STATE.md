...
Generated 24 Sept 2026, 9:33 am by `node scripts/live-state.mjs`. Do not edit by hand - rerun it.
...
| | |
|---|---|
| Live bundle built | 24 Sept 2026, 9:31 am (1h ago) |
| Deployment | https://compilance-6j4nsn4nv-chandans-projects-8e0b4ca0.vercel.app |
...
| `compliance-ai` | 90d ago | never recorded | UNKNOWN - never recorded |
| `contract-review` | 81d ago | never recorded | UNKNOWN - never recorded |
| `customs-filing` | 13d ago | never recorded | UNKNOWN - never recorded |
| `document-ocr` | 18d ago | never recorded | UNKNOWN - never recorded |
| `document-review` | 86d ago | never recorded | UNKNOWN - never recorded |
| `fetch-regulatory-feeds` | 190d ago | never recorded | UNKNOWN - never recorded |
| `hs-checklist` | 90d ago | never recorded | UNKNOWN - never recorded |
| `hs-lookup` | 190d ago | never recorded | UNKNOWN - never recorded |
| `hs-mismatch-check` | 86d ago | never recorded | UNKNOWN - never recorded |
| `label-vision` | 184d ago | never recorded | UNKNOWN - never recorded |
| `razorpay-create-link` | 105d ago | never recorded | UNKNOWN - never recorded |
| `razorpay-webhook` | 105d ago | never recorded | UNKNOWN - never recorded |
| `recovery-digest` | 18d ago | never recorded | UNKNOWN - never recorded |
| `regulatory-alerts` | 191d ago | never recorded | UNKNOWN - never recorded |
| `sanctions-check` | 105d ago | never recorded | UNKNOWN - never recorded |
| `treds-financing` | 13d ago | never recorded | UNKNOWN - never recorded |
| `whatsapp-alert` | 13d ago | never recorded | UNKNOWN - never recorded |
| `whatsapp-vendor-outreach` | 208d ago | never recorded | UNKNOWN - never recorded |
| `zonos-classify` | 208d ago | never recorded | UNKNOWN - never recorded |
| `zonos-landed-cost` | 208d ago | never recorded | UNKNOWN - never recorded |
...
| `20260924000001_masters.sql` | yes | 23 Sept 2026, 8:45 pm |
| `20260924000002_invoice_number_per_gstin.sql` | yes | 23 Sept 2026, 9:18 pm |
...
Branch `recover-untracked-edge-functions` at `bd07077` - fix: escape user input in the LC template and RoDTEP report (1h ago).
